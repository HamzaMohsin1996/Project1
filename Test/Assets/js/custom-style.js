...
const intervals = [
  { start: 17, end: 24, label: 'Response Time (20-26s)' },
];
...
button2.addEventListener('click', () => {
  handleButtonClick('Straight Test');
});

button3.addEventListener('click', () => {
  handleButtonClick('Right Turn Test');
});
...
document.addEventListener('keydown', (event) => {
  ...
  switch (keyName) {
    case 'd':
      buttonId = 'RightLane Test';
      break;
    case 's':
      buttonId = 'Stop Test';
      break;
    case 'w':
      buttonId = 'Straight Test';
      break;
    default:
      break;
  }
